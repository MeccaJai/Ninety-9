            ...
            <>
                ...
                <div className = "container">
                    <div className="col mb-3" >
                        <br/>
                        <div className="card h-100 position-relative mb-4">
                        ...
                        <div className="card h-100 position-relative">
                            <h5 className = "clickCard text-end shrik mb-4 mt-4 appMar">
                                Approve? <i class="fa-solid fa-check" style={{color: 'rgba(79, 217, 37)'}}></i>  &nbsp; Deny? <i class="fa-solid fa-ban" style={{color: 'rgba(246, 1, 1)'}}></i>
                            </h5>
                        </div>
                    </div>
                </div>
...
const Approval = withParams(Approvals);
